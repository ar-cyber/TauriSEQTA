    ...
    {#if selectedSubject}
      {#if loadingCourse}
        <div class="flex justify-center items-center w-full">
          <div class="text-lg text-gray-600 dark:text-slate-400">Loading course content...</div>
        </div>
      {:else if courseError}
        <div class="flex justify-center items-center w-full">
          <div class="text-lg text-red-500 dark:text-red-400">Error loading course: {courseError}</div>
        </div>
      ...
      {:else}
        <div class="flex justify-center items-center w-full">
          <div class="text-lg text-gray-600 dark:text-slate-400">No course content available</div>
        </div>
      {/if}
    {:else}
      <div class="flex justify-center items-center w-full">
        <div class="text-lg text-gray-600 dark:text-slate-400">Select a subject to view course content</div>
      </div>
    {/if}
  </div>
</div>
