...
<div class="flex flex-col h-screen">
  ...
  <header class="flex justify-between items-center px-6 w-full h-16">
    <div class="flex items-center space-x-4">
      <button
        class="flex justify-center items-center w-10 h-10 rounded-xl transition-all duration-200 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-slate-500/50"
        onclick={() => (sidebarOpen = !sidebarOpen)}
        aria-label="Toggle sidebar">
        <Icon src={Bars3} class="w-5 h-5 text-slate-700 dark:text-slate-300" />
      </button>
    ...
    <div class="flex items-center space-x-2">
      <button
        class="flex relative justify-center items-center rounded-xl border transition-all duration-200 size-12 bg-white/60 border-slate-200/40 hover:bg-white/80 dark:bg-slate-800/60 dark:border-slate-700/40 dark:hover:bg-slate-800/80 focus:outline-none focus:ring-2 focus:ring-slate-500/50"
        onclick={() => (notifications = [])}>
        <Icon src={Bell} class="w-5 h-5 text-slate-700 dark:text-slate-300" />
      ...
      {#if userInfo}
        <div class="relative user-dropdown-container">
          <button
            class="flex gap-3 items-center px-4 py-2 rounded-xl border transition-all duration-200 bg-white/60 border-slate-200/40 hover:bg-white/80 dark:bg-slate-800/60 dark:border-slate-700/40 dark:hover:bg-slate-800/80 focus:outline-none focus:ring-2 focus:ring-slate-500/50"
              ...
              <div class="p-2">
                <button
                  ...
                  <div class="flex-1">
                    ...
                    <div class="text-xs text-slate-500 dark:text-slate-400">App information</div>
                  </div>
                </button>
    ...
    <aside
      ...
      <nav class="p-4 py-[1px] space-y-2 w-64 min-w-64">
        {#each menu as item}
          <a
            href={item.path}
            class="flex gap-4 items-center text-md px-3 py-3 font-medium rounded-xl transition-all duration-200 hover:bg-slate-100/50 dark:hover:bg-slate-800/50 focus:outline-none {(
              item.path === '/'
                ? $page.url.pathname === '/'
                : $page.url.pathname.startsWith(item.path)
            )
              ? 'bg-slate-100/50 ring-1 ring-slate-300/40 text-slate-900 dark:bg-slate-800/50 dark:ring-slate-700/50 dark:text-white'
